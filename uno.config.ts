...
export default unocss.defineConfig({
    ...
    shortcuts: {
        ...
        'icon-vercel': 'i-tabler:brand-vercel text-5 text-gray @hover:text-[#f5f5f5] transition-color ease-in-out duration-300',
        'icon-discord': 'i-tabler:brand-discord text-5 text-gray @hover:text-[#5865f2] transition-color ease-in-out duration-300',
        'icon-github': 'i-tabler:brand-github text-5 text-gray @hover:text-[#f5f5f5] transition-color ease-in-out duration-300',
        'icon-reddit': 'i-tabler:brand-reddit text-5 text-gray @hover:text-[#ec4001] transition-color ease-in-out duration-300',
        'icon-spotify': 'i-tabler:brand-spotify text-5 text-gray @hover:text-[#138a3d] transition-color ease-in-out duration-300',
        'icon-twitch': 'i-tabler:brand-twitch text-5 text-gray @hover:text-[#843feb] transition-color ease-in-out duration-300',
        'icon-twitter': 'i-tabler:brand-twitter text-5 text-gray @hover:text-[#1b8fdd] transition-color ease-in-out duration-300',
        'icon-youtube': 'i-tabler:brand-youtube text-5 text-gray @hover:text-[#db0808] transition-color ease-in-out duration-300',
