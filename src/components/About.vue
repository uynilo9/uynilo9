...
<template>
	<div class="h-inherit grid grid-content-between">
		<p class="font-400 text-4 lh-normal text-default">
			I'm thinkging what I'm gonna leave here...
			...
			some interesting but tiny programs when there's nothing to do
			(lmao). I hope one day I could become a Full-stack Programmer (but
			professional) / Gaming Streamer / Physics Enthusiast (sounds like
